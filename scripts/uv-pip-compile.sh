...
# -c requirements/constraints.txt ensures transitive deps respect security pins
uv pip compile pyproject.toml requirements/base.in -c requirements/constraints.txt -o requirements/base.txt $ADDITIONAL_ARGS
...
uv pip compile requirements/development.in -c requirements/base-constraint.txt -c requirements/constraints.txt -o requirements/development.txt $ADDITIONAL_ARGS
